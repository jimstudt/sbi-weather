/**
 * This file originiated as spi/bme280_spi/bme280_spi.c in the Pi Pico SDK
 * examples. It was an SPI example program. I am butchering it to be an 
 * i2c library, their copyright remains.
 *
